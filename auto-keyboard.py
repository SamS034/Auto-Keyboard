...
# Changelog: ALPHA v2
# 1. user define end keys (note: the end key will still be triggered.) (COMPLETED)
# 2. Force user to run the program with elevated privilages (COMPLETED)
# 3. Start recording key and end record key to not be repeated (COMPLETED)

# INFO: BUG LIST (03/08/20)
# None.....yet
